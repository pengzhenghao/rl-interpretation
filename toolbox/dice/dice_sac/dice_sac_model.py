...
class SACModel(TFModelV2):
    ...
    def __init__(self,
        ...
        self.diversity_q_net = build_q_net(
            "diversity_q", self.model_out, self.actions_input)
        self.register_variables(self.q_net.variables)
        self.register_variables(self.diversity_q_net.variables)
    ...
    def get_diversity_q_values(self, model_out, actions=None):
        if actions is not None:
