...
def get_spearman(probe_mask, norm_next_obs_diff, batch_size=1000000,
                 pval_th=0.05):
    rho, pval = scipy.stats.spearmanr(probe_mask[:batch_size],
                                      norm_next_obs_diff[:batch_size], axis=0)
